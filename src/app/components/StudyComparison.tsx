...
export default function StudyComparison() {
  ...
  // Find weakest concept (lowest combined score)
    ...
    <div style={{ maxWidth: "1000px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", marginBottom: "1.75rem" }}>
        {[
          ...
          <div key={p.name} style={{ backgroundColor: "#FFFFFF", borderRadius: "12px", padding: "1.25rem", boxShadow: "0 1px 3px rgba(0,0,0,0.06)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "1rem" }}>
              <div style={{ width: "38px", height: "38px", borderRadius: "50%", backgroundColor: p.color, display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontWeight: 700, fontSize: "0.875rem" }}>
                {p.initial}
              </div>
              <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "0.5rem", textAlign: "center" }}>
              {[
                ...
                <div key={b.label} style={{ backgroundColor: b.bg, borderRadius: "8px", padding: "0.5rem" }}>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.875rem" }}>
            <thead>
              <tr style={{ backgroundColor: "#F9FAFB" }}>
                {["문제번호", "핵심 개념", "과목", "세은 이해도", "수철 이해도", "추천 설명 담당자"].map((h) => (
            ...
            <tbody>
              {ROWS.map((row) => {
                const rec = getRecommend(row.se, row.su);
                return (
                  <tr key={row.id} style={{ borderTop: "1px solid #F3F4F6" }}>
                    ...
                    <td style={{ padding: "0.875rem 1rem" }}><Badge val={row.se} /></td>
                    <td style={{ padding: "0.875rem 1rem" }}><Badge val={row.su} /></td>
